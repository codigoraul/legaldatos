...
$SITE_URL = (isset($_SERVER['HTTP_HOST']) && is_string($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] !== '')
  ...
  : 'https://www.legaldatos.cl';

$TO_EMAILS_BASE = 'contacto@legaldatos.cl, daniel.manriquez.sansigolo@gmail.com, codigoraul@gmail.com';
$TO_EMAIL = $TO_EMAILS_BASE;
$FROM_EMAIL = 'contacto@legaldatos.cl';
$FROM_NAME = 'LegalDatos';
$BCC_EMAILS = '';
...
$subject = 'Nueva consulta desde legaldatos.cl';
...
$bodyHtml = '<!doctype html><html><head><meta charset="UTF-8"></head><body style="font-family:Arial,Helvetica,sans-serif; color:#111827;">'
  . '<h2 style="margin:0 0 16px; font-size:18px;">Nueva consulta desde LegalDatos</h2>'
...
$bodyText = "Nueva consulta desde LegalDatos\n\n"
  . "Nombre: {$nombre}\n"
  . "Email: {$email}\n"
  . "Teléfono: {$telefono}\n\n"
  . "Mensaje:\n{$mensaje}\n";

$boundary = 'legaldatos_' . bin2hex(random_bytes(12));
$body = "--{$boundary}\r\n"
